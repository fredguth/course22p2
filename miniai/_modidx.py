...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'miniai.accel': { 'miniai.accel.AccelerateCB': ('ddpm_v2.html#acceleratecb', 'miniai/accel.py'),
            ...
            'miniai.fisher': { 'miniai.fisher.FisherCB': ('fishercallback.html#fishercb', 'miniai/fisher.py'),
                               'miniai.fisher.FisherCB.__init__': ('fishercallback.html#fishercb.__init__', 'miniai/fisher.py'),
                               'miniai.fisher.FisherCB._log': ('fishercallback.html#fishercb._log', 'miniai/fisher.py'),
                               'miniai.fisher.FisherCB.after_epoch': ('fishercallback.html#fishercb.after_epoch', 'miniai/fisher.py'),
